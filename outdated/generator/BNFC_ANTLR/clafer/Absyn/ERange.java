...
public class ERange  extends Exp {
  public final Exp exp_1, exp_2;
  public ERange(Exp p1, Exp p2) { exp_1 = p1; exp_2 = p2; }

  public <R,A> R accept(clafer.Absyn.Exp.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(java.lang.Object o) {
    if (this == o) return true;
    if (o instanceof clafer.Absyn.ERange) {
      clafer.Absyn.ERange x = (clafer.Absyn.ERange)o;
