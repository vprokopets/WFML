...
public class TmpPatLessOrOnce  extends Exp {
  public final Exp exp_;
  public final PatternScope patternscope_;
  public TmpPatLessOrOnce(Exp p1, PatternScope p2) { exp_ = p1; patternscope_ = p2; }

  public <R,A> R accept(clafer.Absyn.Exp.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(java.lang.Object o) {
    if (this == o) return true;
    if (o instanceof clafer.Absyn.TmpPatLessOrOnce) {
      clafer.Absyn.TmpPatLessOrOnce x = (clafer.Absyn.TmpPatLessOrOnce)o;
