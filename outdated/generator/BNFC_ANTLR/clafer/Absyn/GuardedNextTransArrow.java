...
public class GuardedNextTransArrow  extends TransArrow {
  public final TransGuard transguard_;
  public GuardedNextTransArrow(TransGuard p1) { transguard_ = p1; }

  public <R,A> R accept(clafer.Absyn.TransArrow.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(java.lang.Object o) {
    if (this == o) return true;
    if (o instanceof clafer.Absyn.GuardedNextTransArrow) {
      clafer.Absyn.GuardedNextTransArrow x = (clafer.Absyn.GuardedNextTransArrow)o;
