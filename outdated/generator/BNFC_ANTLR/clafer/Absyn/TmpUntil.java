...
public class TmpUntil  extends Exp {
  public final Exp exp_1, exp_2;
  public TmpUntil(Exp p1, Exp p2) { exp_1 = p1; exp_2 = p2; }

  public <R,A> R accept(clafer.Absyn.Exp.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(java.lang.Object o) {
    if (this == o) return true;
    if (o instanceof clafer.Absyn.TmpUntil) {
      clafer.Absyn.TmpUntil x = (clafer.Absyn.TmpUntil)o;
