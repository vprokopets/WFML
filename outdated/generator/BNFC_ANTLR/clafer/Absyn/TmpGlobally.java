...
public class TmpGlobally  extends Exp {
  public final Exp exp_;
  public TmpGlobally(Exp p1) { exp_ = p1; }

  public <R,A> R accept(clafer.Absyn.Exp.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(java.lang.Object o) {
    if (this == o) return true;
    if (o instanceof clafer.Absyn.TmpGlobally) {
      clafer.Absyn.TmpGlobally x = (clafer.Absyn.TmpGlobally)o;
