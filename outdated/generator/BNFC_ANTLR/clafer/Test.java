...
public class Test
{
  ...
  public Test(String[] args)
  {
    try
    {
      ...
      l = new claferLexer(new ANTLRInputStream(input));
    ...
    p = new claferParser(new CommonTokenStream(l));
            p.addErrorListener(new BNFCErrorListener());
  }

  public clafer.Absyn.Module parse() throws Exception
  {
    /* The default parser is the first-defined entry point. */
    /* Other options are: */
    /* clafer, constraint, assertion, goal */
    claferParser.Start_ModuleContext pc = p.start_Module();
